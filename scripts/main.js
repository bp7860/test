...
var _l = new Array(
		new Array( "Information", "Kontakt", "Ausstattung", "Anmerkung", "Preise", "Impressionen", "Erwachsene", "Kinder", "Auto", "Wohnanhänger", "Wohnmobil", "großes Zelt", "Zelt",
					"Motorrad", "Hunde", "Strom", "Home", "Service", "Details", "Impressum", "Partner", "Weitere Services", "Update", "Anfahrt", "Regionen" ),
		new Array( "Information", "Contact", "Equipment", "Description", "Prices", "Impressions", "Adults", "Kids", "Car", "Caravan", "Camper", "Marquee", "Tent",
					"Motorbike", "Dog", "Electricity", "Home", "Service", "Details", "Imprint", "Partners", "More Services", "Update", "Map", "Regions" ),
		new Array(),
		...
		new Array( "Informatie", "Contact", "Uitrusting", "Opmerking", "Prijzen", "Impressies", "Volwassenen", "Kinderen", "Auto", "Caravan", "Camper", "Grote tent", "Tent",
					"Motor", "Honden", "Stroom", "Home", "Service", "Details", "Impressum", "Partner", "Andere services", "Update", "Route", "Weer", "Verkeer", "Camping Südtirol", "Campingplaatsen", "Regions" )
	);
...
var area = new Array(
		...
		new Array(  ),
		new Array( 
			"Bozen und Umgebung" => "Bolzano (265 m), hoofdstad van het gewest Zuid-Tirol, is een stad met twee gezichten; on-italiaans en haast koud aandoend voor de mensen uit het zuiden, mediterraans voor de mensen die uit het noorden komen. In de onmiddellijke nabijheid wordt de stad omringd door bergketens verscheidene: de Ritten met zijn piramides van aarde en de aantrekkelijke hotelletjes, Jenesien aan de Tschöggelberg en de Kohlernberg (de oudste kabelspoorbaan ter wereld), voor een uitstapje dichtbij. Ook dichtbij bevindt zich het originele Sarndal, niet alleen bekend om zijn klederdrachten, maar ook om zijn borduurwerk met penneschachten. In Bolzano heeft ook de man uit het ijs \"Ötzi\" zijn laatste rustplaats gevonden in het archeologisch museum.",
			"Der Süden Südtirols" => "Hier worden alle belangrijke zaken afgewikkeld bij een \"glas goede wijn\". De zon verwekt een rijke varieteit aan vruchten in dit weelderige landschap van fruitbomen en wijngaarden, want grote oppervlakten van fruitboomkwekerijen en een sinds honderden jaren uitgeoefende wijnbouw bepalen het beeld van deze landstreek. Vlak aan de \"wijnweg\" bevindt zich de Kalterer See beschouwd wordt als het gebied van oorsprong van de wereldbekende wijn. Niet alleen bij de wijnbouwers maar ook in de gastvrije uitspanningen kan men zich heerlijk laten verwennen.",
			"Dolomiten/Pustertal" => "Ten zuidoosten van het Etsch- en Eisackdal rijst het \"land der bergen\" op, zoals de Dolomieten met zijn rijk afwisselende natuurlandschap in de volksmond genoemd worden. De Dolomieten, ontstaan uit de oerzeen - fabelachtige sprookjesarchitectuur - bizarre bergwanden; beschreven, uitgebeeld en bezongen; te leren kennen, te beklimmen en te beleven. Nergens anders zijn er zoveel natuurparken. Vele volksverhalen, gebruiken en tradities spreken hun eigen taal, maar allemaal vertellen ze van de fascinerende wereld der \"bleke bergen\".",
			"Eisacktal – Wipptal" => "Men bevindt zich hier op het traditionele noord-zuid verbindingspunt van Zuid-Tirol en niet alleen de handel profiteert van deze gunstige ligging, maar ook de drie belangrijkste plaatsen, nl. het stadje Sterzing, de voormalige bisschopsstad Brixen en Klausen, ooit een beroemd artiestenoord. Maar ver van het historische transito-gebied tussen Bolzano en de Brenner bepalen oude, afgelegen boerderijen, her en der verspreide dorpjes en gehuchten het beeld van de oeroude, kleine zijvalleien.",
			"Meranerland" => "Het landschap van fruitbomen en wijngaarden, de subtropische plantenwereld, de wandellanen en de weggetjes langs de rivier en vooral het door de eeuwen heen aan dezelfde familie behorende kasteel van de Graaf van Tirol hebben van oudsher gasten naar de burggraafstad gelokt. Mensen die naar rust verlangen kunnen daar in deze streek van genieten; in de kleine zijdalen zoals het Ultental met zijn door de zon verweerde houten boerderijen of in het Passeiertal, een microkosmos in de Alpen, met hooggelegen wegen over bergpassen, die hun door het boerenleven gevormde karakter hebben behouden.",
...
function showItem(urlObj, options) {
	...
	if (item) {
		...
		'		</p>'+
		'	<!--/div-->'+
		'		<div class="header_text">'+_l[Lang][28]+'</div>'+
		'		<p>'+area[Lang][region_name]+'</p>'+
		'	<!--div data-role="collapsible" data-mini="true" id="col-kontakt"-->'+
