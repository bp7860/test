	...
	if (item) {
		...
		$.each(item.equipment, function (key, val) {
			...
			equipment_tmp+='<div class="ui-block-'+grid+'">'+
				'<a href="#popupInfo_'+ val +'" data-rel="popup" data-transition="pop" class="my-tooltip-btn ui-btn ui-alt-icon ui-nodisc-icon ui-btn-inline ui-icon-info ui-btn-icon-notext">adsf</a>'+
